					...
					<div class="sprtf-start-page-wrap">
						<div class="sprtf-video-area">
							...
							<ul>
								...
								<li><a target="_blank" class='sprtf-medium-btn' href="https://realtestimonials.io/real-testimonials-lite-version-demo/">Live Demo</a></li>
					...
					<div class="sprtf-lite-to-pro-wrap">
						...
						<div class="sprtf-upgrade-to-pro">
							...
							<div class="sprtf-upgrade-to-pro-btn">
								...
								<a target="_blank" class="sprtf-big-btn-border sprtf-pro-live-btn" href="https://realtestimonials.io/slider/">Pro Live Demo</a>
							</div>
						</div>
					</div>
